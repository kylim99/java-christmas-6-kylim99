...
- [x] 메뉴와 갯수를 입력 받는다.
  ...
  - [x] 갯수가 1 이상이 아니면 에러 매시지를 출력 후 입력을 다시 받는다.
  - [x] 중복 매뉴를 입력 받으면 에러 매시지를 출력 후 입력을 다시 받는다.
  - [x] 음료만 주문 시 에러 매시지를 출력 후 입력을 다시 받는다.
  - [x] 갯수의 총합이 20이 넘으면 에러 매시지를 출력 후 입력을 다시 받는다.
