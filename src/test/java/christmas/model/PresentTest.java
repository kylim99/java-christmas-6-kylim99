...
public class PresentTest {
    ...
    void 증정품_테스트(){
        ...
        assertThat(present.getPresent()).isEqualTo("샴페인 1개");
        assertThat(present.getPresentLog()).isEqualTo("증정 이벤트: -25,000원");
        assertThat(present.getPresentPrice()).isEqualTo(25000);
    }
}
